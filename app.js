...
const starterIndex = pokemon.findIndex((pokemonp) => pokemonp.starter === true);
game.party.push(pokemon[starterIndex]);


/*
Exercise 5
1. Choose three or more Pokémon from the `pokemon` array and add them to your party.
...
game.party.push(pokemon[39],pokemon[80],pokemon[100]);
...
game.catchPokemon = (pokemonmine) => {
  game.party.push(pokemonmine);
};
...
game.partyCount = () => {
  let count = 0;
  for (let pokemonp of game.party) {
    count++;
  }
  return count;
}
